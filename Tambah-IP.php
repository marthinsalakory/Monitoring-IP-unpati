...
<body>
    ...
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p>Dibawah ini adalah form pengisian IP baru situs-situs Universitas Pattimura</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="well">
                    <form class="form-horizontal" method="POST" action="Tambah-IP.php">
                        <fieldset>
                            ...
                            <legend>Tambah IP</legend>
                            <div class="form-group" id="nama_situs">
                                <label for="nama" class="col-lg-2 control-label">Nama Situs</label>
                                <div class="col-lg-10">
                                    <input autocomplete="off" class="form-control" name="nama" id="nama" placeholder="Masukan nama situs disini" type="text" spellcheck="false" data-ms-editor="true">
                                </div>
                            </div>
                            <div class="form-group" id="ip_situs">
                                <label for="ip" class="col-lg-2 control-label">IP Baru</label>
                                <div class="col-lg-10">
                                    <input autocomplete="off" class="form-control" name="ip" id="ip" placeholder="Masukan Ip Baru disini" type="text" spellcheck="false" data-ms-editor="true">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi1" value="Umum" checked="" type="radio">
                                            Umum
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Ekonomi dan Bisnis" type="radio">
                                            Fakultas Ekonomi dan Bisnis
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Hukum" type="radio">
                                            Fakultas Hukum
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Kedokteran" type="radio">
                                            Fakultas Kedokteran
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Ilmu Sosial dan Ilmu Politik" type="radio">
                                            Fakultas Ilmu Sosial dan Ilmu Politik
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Teknik" type="radio">
                                            Fakultas Teknik
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Pertanian" type="radio">
                                            Fakultas Pertanian
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Matematika dan Ilmu Pengetahuan Alam" type="radio">
                                            Fakultas Matematika dan Ilmu Pengetahuan Alam
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Keguruan dan Ilmu Pendidikan" type="radio">
                                            Fakultas Keguruan dan Ilmu Pendidikan
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="lokasi" id="lokasi2" value="Fakultas Perikanan dan Ilmu Kelautan" type="radio">
                            ...
                            <div class="form-group">
                                <div class="col-lg-10 col-lg-offset-2">
                                    ...
                                    <button name="tambah" id="tambah_ip" type="submit" class="btn btn-primary">Tambah IP</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
